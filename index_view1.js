...
const createView1SVG = () => {
    ...
    datasetArr.forEach((d, i) => {
        ...
        ul.append("li").text(`Linking errors - ${d.trkIDToErrTrkIDPredMap.size}`)
        ul.append("li").text(`Linking errors (%) - ${round2Decimal(d.trkIDToErrTrkIDPredMap.size / d.idxToTrkIDArr.length * 100)}%`)
