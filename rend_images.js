var imgIndex = 0;
const VIEW_BOX_WIDTH = 2300;
var VIEW_BOX_HEIGHT = 1300;
...
const indexDisplay = imgGroup.append("text")
    ...
    .attr("transform", `translate(${(IMAGE_WIDTH - document.getElementsByClassName("imageIndexText")[0].getBBox().width) / 2}, ${-10})`);
// rend image
